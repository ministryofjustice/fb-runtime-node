...
const flattenSources = (sourceObjs) => {
  ...
  const expandIsa = (instance) => {
     ...
     */
    if (/@ministryofjustice\/fb-components-core/.test(instance._isa)) {
      instance._isa = instance._isa.replace(/@ministryofjustice\/fb-components-core/, '@ministryofjustice/fb-components')
    }
